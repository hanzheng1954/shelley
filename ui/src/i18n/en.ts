...
export const en: TranslationKeys = {
  ...
  dream: "Dream",
  selectConversationForExperience: "Select a conversation with a working directory first.",
  searchProjectMemory: "Search project memory",
  search: "Search",
  addMemory: "Add memory",
  shortTitle: "Short title",
  verifiedReusableProjectKnowledge: "Verified, reusable project knowledge",
  confidence: "Confidence",
  saveMemory: "Save memory",
  noProjectMemories: "No project memories yet.",
  checkpointSummary: "Checkpoint summary",
  currentGoal: "Current goal",
  nextAction: "Next action",
  saveCheckpoint: "Save checkpoint",
  openConversationForJournal: "Open a conversation to manage its task journal.",
  noCheckpoints: "No checkpoints in this conversation.",
  consolidateThisTask: "Consolidate this task",
  dreamDescription:
    "Ask the active agent to review verified work and save reusable project lessons.",
  dreamAgentPrompt:
