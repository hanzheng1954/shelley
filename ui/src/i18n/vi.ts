...
export const vi: TranslationKeys = {
  ...
  memory: "Bộ nhớ",
  taskJournal: "Nhật ký tác vụ",
  dream: "Dream",
  selectConversationForExperience: "Trước tiên, hãy chọn một cuộc trò chuyện có thư mục làm việc.",
  searchProjectMemory: "Tìm trong bộ nhớ dự án",
  search: "Tìm kiếm",
  addMemory: "Thêm ghi nhớ",
  shortTitle: "Tiêu đề ngắn",
  verifiedReusableProjectKnowledge: "Kiến thức dự án đã xác minh và có thể tái sử dụng",
  confidence: "Độ tin cậy",
  saveMemory: "Lưu ghi nhớ",
  noProjectMemories: "Dự án chưa có ghi nhớ.",
  checkpointSummary: "Tóm tắt điểm kiểm tra",
  currentGoal: "Mục tiêu hiện tại",
  nextAction: "Hành động tiếp theo",
  saveCheckpoint: "Lưu điểm kiểm tra",
  openConversationForJournal: "Mở một cuộc trò chuyện để quản lý nhật ký tác vụ.",
  noCheckpoints: "Cuộc trò chuyện này chưa có điểm kiểm tra.",
  consolidateThisTask: "Tổng hợp tác vụ này",
  dreamDescription:
    "Yêu cầu tác nhân đang hoạt động xem lại công việc đã xác minh và lưu các bài học có thể tái sử dụng.",
  dreamAgentPrompt:
  ...
  kindPreference: "Tùy chọn",
  kindLesson: "Bài học",
  manualCheckpoint: "Thủ công",
  agentCheckpoint: "Điểm kiểm tra",
