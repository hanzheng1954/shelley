...
export const ru: TranslationKeys = {
  ...
  // Project Experience
  projectExperience: "Опыт проекта",
  memory: "Память",
  taskJournal: "Журнал задачи",
  dream: "Dream",
  selectConversationForExperience: "Сначала выберите беседу с рабочим каталогом.",
  searchProjectMemory: "Поиск в памяти проекта",
  search: "Найти",
  addMemory: "Добавить запись",
  shortTitle: "Краткий заголовок",
  verifiedReusableProjectKnowledge: "Проверенные знания проекта для повторного использования",
  confidence: "Уверенность",
  saveMemory: "Сохранить запись",
  noProjectMemories: "В проекте пока нет записей памяти.",
  checkpointSummary: "Описание контрольной точки",
  currentGoal: "Текущая цель",
  nextAction: "Следующее действие",
  saveCheckpoint: "Сохранить контрольную точку",
  openConversationForJournal: "Откройте беседу, чтобы управлять журналом задачи.",
  noCheckpoints: "В этой беседе нет контрольных точек.",
  consolidateThisTask: "Обобщить эту задачу",
  dreamDescription:
    "Попросить активного агента проверить выполненную работу и сохранить полезные выводы.",
  dreamAgentPrompt:
    "Проверь завершённую и подтверждённую работу в этой беседе и запусти Dream. Сохраняй только полезные для повторного использования выводы с подтверждённым источником; можно не сохранять ничего.",
  runDream: "Запустить Dream",
  refresh: "Обновить",
  dreamRequested: "Dream запрошен. Обновите вкладку после завершения работы агента.",
  noDreamRuns: "Для этого проекта ещё не запускался Dream.",
  memories: "записей",
  goalLabel: "Цель:",
  nextLabel: "Далее:",
  kindFact: "Факт",
  kindDecision: "Решение",
  kindPreference: "Предпочтение",
  kindLesson: "Урок",
  manualCheckpoint: "Вручную",
  agentCheckpoint: "Контрольная точка",
