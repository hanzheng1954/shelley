...
export const ja: TranslationKeys = {
  ...
  // Project Experience
  projectExperience: "プロジェクトの経験",
  memory: "メモリ",
  taskJournal: "タスクジャーナル",
  dream: "Dream",
  selectConversationForExperience: "作業ディレクトリのある会話を先に選択してください。",
  searchProjectMemory: "プロジェクトメモリを検索",
  search: "検索",
  addMemory: "メモリを追加",
  shortTitle: "短いタイトル",
  verifiedReusableProjectKnowledge: "検証済みで再利用可能なプロジェクト知識",
  confidence: "信頼度",
  saveMemory: "メモリを保存",
  noProjectMemories: "プロジェクトメモリはまだありません。",
  checkpointSummary: "チェックポイントの概要",
  currentGoal: "現在の目標",
  nextAction: "次のアクション",
  saveCheckpoint: "チェックポイントを保存",
  openConversationForJournal: "会話を開いてタスクジャーナルを管理します。",
  noCheckpoints: "この会話にはチェックポイントがありません。",
  consolidateThisTask: "このタスクを統合",
  dreamDescription:
    "アクティブなエージェントに検証済みの作業を振り返らせ、再利用可能な知見を保存します。",
  dreamAgentPrompt:
