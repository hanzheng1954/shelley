...
export const upgoer5: TranslationKeys = {
  ...
  // Project Experience
  projectExperience: "Things this work place knows",
  memory: "Things to remember",
  taskJournal: "Work notes",
  dream: "Think over work",
  selectConversationForExperience: "First pick a talk that has a work place.",
  searchProjectMemory: "Look through things remembered",
  search: "Look",
  addMemory: "Remember a thing",
  shortTitle: "Short name",
  verifiedReusableProjectKnowledge: "A checked thing that can help with later work",
  confidence: "How sure",
  saveMemory: "Remember it",
  noProjectMemories: "Nothing has been remembered for this work place yet.",
  checkpointSummary: "Short work note",
  currentGoal: "What we are trying to do",
  nextAction: "What to do next",
  saveCheckpoint: "Save work note",
  openConversationForJournal: "Open a talk to see and save its work notes.",
  noCheckpoints: "This talk has no saved work notes.",
  consolidateThisTask: "Think over this work",
  dreamDescription:
    "Ask the working helper to look over checked work and remember things that can help later.",
  dreamAgentPrompt:
  ...
  goalLabel: "What we want:",
  nextLabel: "Next:",
  kindFact: "Thing known",
  kindDecision: "Choice",
  kindPreference: "What is liked",
  kindLesson: "Thing learned",
  manualCheckpoint: "Saved by hand",
  agentCheckpoint: "Work note",
  restoreCheckpoint: "Bring back work note",
  inputLabel: "What went in:",
  resultLabel: "What came out:",
  noOutput: "(nothing came out)",
