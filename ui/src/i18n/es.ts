...
export const es: TranslationKeys = {
  ...
  // Project Experience
  projectExperience: "Experiencia del proyecto",
  memory: "Memoria",
  taskJournal: "Diario de tareas",
  dream: "Dream",
  selectConversationForExperience:
    "Primero selecciona una conversación con un directorio de trabajo.",
  searchProjectMemory: "Buscar en la memoria del proyecto",
  search: "Buscar",
  addMemory: "Añadir memoria",
  shortTitle: "Título breve",
  verifiedReusableProjectKnowledge: "Conocimiento verificado y reutilizable del proyecto",
  confidence: "Confianza",
  saveMemory: "Guardar memoria",
  noProjectMemories: "Aún no hay memorias del proyecto.",
  checkpointSummary: "Resumen del punto de control",
  currentGoal: "Objetivo actual",
  nextAction: "Siguiente acción",
  saveCheckpoint: "Guardar punto de control",
  openConversationForJournal: "Abre una conversación para administrar su diario de tareas.",
  noCheckpoints: "No hay puntos de control en esta conversación.",
  consolidateThisTask: "Consolidar esta tarea",
  dreamDescription:
    "Pide al agente activo que revise el trabajo verificado y guarde lecciones reutilizables.",
  dreamAgentPrompt:
  ...
  agentCheckpoint: "Punto de control",
