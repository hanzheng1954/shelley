...
export const zhCN: TranslationKeys = {
  ...
  taskJournal: "任务日志",
  dream: "Dream",
  selectConversationForExperience: "请先选择一个带有工作目录的对话。",
  searchProjectMemory: "搜索项目记忆",
  search: "搜索",
  addMemory: "添加记忆",
  shortTitle: "简短标题",
  verifiedReusableProjectKnowledge: "经过验证、可重复使用的项目知识",
  confidence: "置信度",
  saveMemory: "保存记忆",
  noProjectMemories: "此项目还没有记忆。",
  checkpointSummary: "检查点摘要",
  currentGoal: "当前目标",
  nextAction: "下一步操作",
  saveCheckpoint: "保存检查点",
  openConversationForJournal: "打开一个对话以管理其任务日志。",
  noCheckpoints: "此对话中没有检查点。",
  consolidateThisTask: "沉淀此任务",
  dreamDescription: "让当前 Agent 复盘已验证的工作，并保存可复用的项目经验。",
  dreamAgentPrompt:
