...
export const zhTW: TranslationKeys = {
  ...
  taskJournal: "任務日誌",
  dream: "Dream",
  selectConversationForExperience: "請先選擇一個含有工作目錄的對話。",
  searchProjectMemory: "搜尋專案記憶",
  search: "搜尋",
  addMemory: "新增記憶",
  shortTitle: "簡短標題",
  verifiedReusableProjectKnowledge: "經過驗證、可重複使用的專案知識",
  confidence: "信心度",
  saveMemory: "儲存記憶",
  noProjectMemories: "此專案尚無記憶。",
  checkpointSummary: "檢查點摘要",
  currentGoal: "目前目標",
  nextAction: "下一步操作",
  saveCheckpoint: "儲存檢查點",
  openConversationForJournal: "開啟一個對話以管理其任務日誌。",
  noCheckpoints: "此對話中沒有檢查點。",
  consolidateThisTask: "沉澱此任務",
  dreamDescription: "讓目前的 Agent 複盤已驗證的工作，並儲存可重用的專案經驗。",
  dreamAgentPrompt:
