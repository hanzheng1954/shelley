...
export const fr: TranslationKeys = {
  ...
  // Project Experience
  projectExperience: "Expérience du projet",
  memory: "Mémoire",
  taskJournal: "Journal de tâche",
  dream: "Dream",
  selectConversationForExperience:
    "Sélectionnez d’abord une conversation avec un répertoire de travail.",
  searchProjectMemory: "Rechercher dans la mémoire du projet",
  search: "Rechercher",
  addMemory: "Ajouter une mémoire",
  shortTitle: "Titre court",
  verifiedReusableProjectKnowledge: "Connaissance vérifiée et réutilisable du projet",
  confidence: "Confiance",
  saveMemory: "Enregistrer la mémoire",
  noProjectMemories: "Aucune mémoire pour ce projet.",
  checkpointSummary: "Résumé du point de reprise",
  currentGoal: "Objectif actuel",
  nextAction: "Prochaine action",
  saveCheckpoint: "Enregistrer le point de reprise",
  openConversationForJournal: "Ouvrez une conversation pour gérer son journal de tâche.",
  noCheckpoints: "Aucun point de reprise dans cette conversation.",
  consolidateThisTask: "Consolider cette tâche",
  dreamDescription:
    "Demander à l’agent actif d’examiner le travail vérifié et d’enregistrer les enseignements réutilisables.",
  dreamAgentPrompt:
  ...
  kindLesson: "Enseignement",
  manualCheckpoint: "Manuel",
  agentCheckpoint: "Point de reprise",
  restoreCheckpoint: "Restaurer le point de reprise",
  inputLabel: "Entrée :",
